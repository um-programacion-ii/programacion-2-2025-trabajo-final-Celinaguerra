package com.celi.backend.service.asientos;
...
public class AsientosService {
    ...
    /**
     * Obtiene el mapa de asientos de un evento, incluyendo información de asientos
    ...
    public MapaAsientosDTO obtenerMapaAsientos(Long eventoId, String userId) {
        ...
        if (estadoSeleccion != null && estadoSeleccion.getEventoId() != null
                && estadoSeleccion.getEventoId().equals(eventoId)) {
    ...
    public BloqueoAsientosResponseDTO bloquearAsientos(Long eventoId, String userId) {
        ...
        EstadoSeleccionDTO estadoSeleccion = sesionSeleccionService.obtenerEstado(userId);
        if (estadoSeleccion == null || estadoSeleccion.getAsientosSeleccionados() == null
                || estadoSeleccion.getAsientosSeleccionados().isEmpty()) {
                            ...
                            if (filaStr != null && !filaStr.isEmpty()) {
                                ...
                                if (firstChar >= 'A' && firstChar <= 'Z') {
                                    ...
                                    try {
                                        ...
                                        LOG.warn("No se pudo convertir fila '{}' a Integer, usando 1 por defecto",
                                                filaStr);
                                        filaInt = 1;
                                    }
                                }
