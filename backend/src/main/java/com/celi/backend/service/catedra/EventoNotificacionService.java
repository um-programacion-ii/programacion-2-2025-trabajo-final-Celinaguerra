        ...
        eventoRepository.findByEventoIdCatedra(notificacion.getEventoIdCatedra())
                .ifPresentOrElse(
                        evento -> {
                            ...
                            LOG.info("Evento eliminado exitosamente: eventoIdCatedra={}",
                                    notificacion.getEventoIdCatedra());
                        },
        ...
        eventoRepository.findByEventoIdCatedra(notificacion.getEventoIdCatedra())
                .ifPresentOrElse(
                        evento -> {
                            ...
                            LOG.info("Evento cancelado exitosamente: eventoIdCatedra={}",
                                    notificacion.getEventoIdCatedra());
                        },
                        () -> {
                            ...
                            if (eventoDTO != null) {
                                ...
                                Evento nuevoEvento = eventoMapper.toEntity(eventoDTO);
                                eventoRepository.save(nuevoEvento);
                                LOG.info("Evento creado como cancelado: eventoIdCatedra={}",
                                        notificacion.getEventoIdCatedra());
                            }
                        });
    }
