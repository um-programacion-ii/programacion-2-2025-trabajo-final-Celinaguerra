package com.celi.backend.service.sesion;
...
public class SesionSeleccionService {
     ...
     */
    public void actualizarNombresPersonas(String userId,
            Map<String, EstadoSeleccionDTO.AsientoSeleccionadoDTO> nombresPorAsiento) {
        EstadoSeleccionDTO estado = obtenerEstado(userId);
        if (estado == null) {
