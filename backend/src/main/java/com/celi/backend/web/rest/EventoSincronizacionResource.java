...
import com.celi.backend.service.catedra.EventoSincronizacionService;
...
public class EventoSincronizacionResource {
    ...
    /**
     * {@code POST /api/admin/eventos/sincronizar} : Sincroniza eventos desde el
     * servicio de la cátedra.
     * <p>
     * Este endpoint obtiene todos los eventos del servicio de la cátedra y los
     * sincroniza
     * con la base de datos local. Requiere rol ADMIN y token de cátedra
     * configurado.
     *
     * @return {@link ResponseEntity} con status {@code 200 (OK)} si la
