...
import com.celi.backend.service.IntegranteService;
...
/**
 * REST controller for managing {@link com.celi.backend.domain.Integrante}.
 */
@RestController
...
public class IntegranteResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<IntegranteDTO> createIntegrante(@RequestBody IntegranteDTO integranteDTO) throws URISyntaxException {
    ...
    public ResponseEntity<IntegranteDTO> updateIntegrante(
        ...
        @RequestBody IntegranteDTO integranteDTO
