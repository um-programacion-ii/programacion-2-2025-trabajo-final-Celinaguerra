package com.celi.backend.web.websocket;

import static com.celi.backend.config.WebsocketConfiguration.IP_ADDRESS;
...
import com.celi.backend.web.websocket.dto.ActivityDTO;
