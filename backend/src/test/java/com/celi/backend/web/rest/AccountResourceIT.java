...
import com.celi.backend.config.Constants;
import com.celi.backend.domain.User;
import com.celi.backend.repository.AuthorityRepository;
import com.celi.backend.repository.UserRepository;
import com.celi.backend.security.AuthoritiesConstants;
import com.celi.backend.service.UserService;
import com.celi.backend.service.dto.AdminUserDTO;
import com.celi.backend.service.dto.PasswordChangeDTO;
import com.celi.backend.web.rest.AccountResource;
import com.celi.backend.web.rest.vm.KeyAndPasswordVM;
import com.celi.backend.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
        ...
        static Stream<ManagedUserVM> invalidUsers() {
                return Stream.of(
                                ...
                                createInvalidUser("bob", "123", "Bob", "Green", "bob@example.com", true), // password
                                                                                                          // with only 3
                                                                                                          // digits
                                createInvalidUser("bob", null, "Bob", "Green", "bob@example.com", true) // invalid null
                                                                                                        // password
                );
        }
        ...
        void testChangePassword() throws Exception {
                ...
                restAccountMockMvc
                                .perform(
                                                post("/api/account/change-password")
                                                                .contentType(MediaType.APPLICATION_JSON)
                                                                .content(om.writeValueAsBytes(new PasswordChangeDTO(
