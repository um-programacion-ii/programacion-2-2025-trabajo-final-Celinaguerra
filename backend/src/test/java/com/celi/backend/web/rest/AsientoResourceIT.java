...
class AsientoResourceIT {
    ...
    private static final EstadoAsiento UPDATED_ESTADO = EstadoAsiento.BLOQUEADO;
    ...
    public static Asiento createEntity() {
        return new Asiento().fila(DEFAULT_FILA).columna(DEFAULT_COLUMNA).persona(DEFAULT_PERSONA).estado(DEFAULT_ESTADO);
    }
    ...
    public static Asiento createUpdatedEntity() {
        return new Asiento().fila(UPDATED_FILA).columna(UPDATED_COLUMNA).persona(UPDATED_PERSONA).estado(UPDATED_ESTADO);
    }
    ...
    void partialUpdateAsientoWithPatch() throws Exception {
        ...
        partialUpdatedAsiento.fila(UPDATED_FILA).columna(UPDATED_COLUMNA).persona(UPDATED_PERSONA);
