...
import com.celi.backend.repository.search.UserSearchRepository;
...
import com.celi.backend.service.mapper.UserMapper;
import com.celi.backend.web.rest.UserResource;
...
class UserResourceIT {
        ...
        void getUser() throws Exception {
                ...
                assertThat(cacheManager.getCache(UserRepository.USERS_BY_LOGIN_CACHE).get(user.getLogin(), User.class))
                                .isNull();
        ...
        void updateUser() throws Exception {
                ...
                restUserMockMvc
                                .perform(put("/api/admin/users").contentType(MediaType.APPLICATION_JSON)
                                                .content(om.writeValueAsBytes(userDTO)))
                                .andExpect(status().isOk());
                ...
                assertPersistedUsers(users -> {
                        ...
                        User testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId()))
                                        .findFirst()
                                        .orElseThrow();
        ...
        void deleteUser() throws Exception {
                ...
                // Delete the user
                restUserMockMvc
                                .perform(delete("/api/admin/users/{login}", user.getLogin())
