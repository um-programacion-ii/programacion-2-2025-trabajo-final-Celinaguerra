...
import static com.celi.backend.security.AuthoritiesConstants.ADMIN;
...
public class JwtAuthenticationTestUtils {
    ...
    public static String createExpiredToken(String jwtKey) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder().issuedAt(past).expiresAt(past.plusSeconds(1)).subject("anonymous")
                .build();
